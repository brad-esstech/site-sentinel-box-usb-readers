...
@log = Logger.new('/home/ubuntu/site-sentinel-box-usb-readers/log/egress2.txt', 'daily')
...
initialise_and_connect_to_egress2_reader

@log.info "Sending two beeps to show reader is online..."
reader_online(PCProxLib, "egress2")
@log.info "Beeps sent."
...
until time_to_quit == true
  ...
  if card != 0
    ...
    unless card.to_s.empty?
      ...
      verify_card_access(card, @access_list[:access_list], "out2")
    end
  end
